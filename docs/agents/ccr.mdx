...
## Authentication
Authenticate and configure CCR outside of ANYON. Follow the instructions on the CCR GitHub repo:
...
ANYON does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in ANYON

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in ANYON" />
</Frame>
