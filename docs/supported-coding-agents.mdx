...
description: "Complete guide to all coding agents supported by ANYON, including installation and authentication instructions"
---

ANYON integrates with a variety of coding agents. Each agent requires installation and authentication before use. Select your preferred agent when creating task attempts.
