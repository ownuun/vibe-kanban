---
title: "Install & Run Anyon"
description: "Complete installation guide for Anyon on macOS, Linux, and Windows"
sidebarTitle: "Installation"
---

## Supported Systems

We build and test Anyon on the following systems:
...
Before installing Anyon, ensure you have:

- **Node.js**: Latest LTS version recommended
- **Coding agent authentication**: Authenticate with your preferred coding agents outside of Anyon

## Safety Notice

<Warning>
Anyon runs AI agents with --dangerously-skip-permissions/--yolo flags by default so they can work autonomously without constant approval prompts. Each task runs in an isolated git worktree, preventing agents from interfering with each other.
...
<Step title="Authenticate with a coding agent">
  Before launching Anyon, ensure you're authenticated with at least one [supported coding agent](/supported-coding-agents). Follow the installation and authentication instructions for your preferred agent.
</Step>

<Step title="Install and launch Anyon">
...
<Step title="Optional: Set up MCP integration">
  Streamline task creation with coding agents by [setting up MCP integration](/integrations/anyon-mcp-server).
</Step>
</Steps>
