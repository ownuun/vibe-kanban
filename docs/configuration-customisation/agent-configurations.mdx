...
<Info>
Agent profiles are used throughout ANYON wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. ANYON saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within ANYON for your coding agents
</Card>

<Card title="ANYON MCP Server" icon="plug" href="/integrations/anyon-mcp-server">
  Connect external MCP clients to ANYON's MCP server
</Card>
</CardGroup>
