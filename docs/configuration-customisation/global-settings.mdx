...
<Frame>
<img src="/images/vk-settings.png" alt="ANYON global settings page showing theme options, agent configuration, and GitHub integration settings" />
</Frame>
...
<Frame>
<img src="/images/vk-editor-ssh.png" alt="ANYON settings editor section showing ssh configuration options." />
</Frame>

When running ANYON on a remote server (e.g., accessed via Cloudflare tunnel, ngrok, or as a systemctl service), you can configure VSCode-based editors to open projects via SSH instead of assuming localhost.
...
- ANYON runs on a remote server (VPS, cloud instance, etc.)
...
- Status synchronisation directly from ANYON
...
Enable or disable telemetry data collection to help improve ANYON.
