...
description: "Connect to GitHub to create pull requests and manage your workflow directly from ANYON"
---
...
4. Authorize ANYON in your browser
5. Return to complete the setup

**Required Permissions**: ANYON needs access to your repositories (`repo`), basic profile info (`read:user`), and email address (`user:email`) for Git commits.
