...
description: "Complete guide to using the ANYON extension with VSCode, Cursor, and Windsurf"
---

The ANYON VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode and popular forks including Cursor and Windsurf.
...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.vibe-kanban">
  Install the official ANYON extension for VSCode
</Card>
...
<Steps>
<Step title="Start a task in ANYON">
...
<Step title="Launch IDE integration">
  ...
  <Note>
  The button text will reflect your editor choice configured in ANYON settings.
  </Note>
</Step>
...
**Solution**: Ensure you're working within a worktree created by a ANYON task.

<Warning>
The extension can only display task information when VSCode is opened in a directory that corresponds to an active ANYON task worktree.
</Warning>

**Steps to resolve**:
1. Verify you opened VSCode through the "Open in [IDE]" button from a ANYON task
...
**Problem**: The ANYON extension doesn't appear in your IDE.
...
<Tip>
**Workflow Optimization**: Always start tasks from the ANYON web interface before opening in your IDE to ensure proper context and worktree setup.
</Tip>
