...
Preview Mode provides an embedded browser experience within ANYON, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and ANYON by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in ANYON
...
<Step title="Install Web Companion">
  ...
  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have ANYON create a task that installs and configures the companion for you.
...
3. **Interact with your app** directly within ANYON
...
<Step title="Activate Selection Mode">
  Click the floating ANYON companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, ANYON shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise ANYON settings
