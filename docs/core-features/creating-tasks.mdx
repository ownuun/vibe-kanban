...
<Tip>
For detailed setup instructions and examples, see the [ANYON MCP Server](/integrations/anyon-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your ANYON project based on this description.
